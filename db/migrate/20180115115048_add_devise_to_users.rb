...
class AddDeviseToUsers < ActiveRecord::Migration[5.1]
  ...
  def self.down
    remove_columns( :users, :ecrypted_password_token, :reset_password_sent_at, :remember_created_at,
                    :sign_in_count, :current_sign_in_at, :last_sign_in_at, :current_sign_in_ip,
                    :last_sign_in_ip, :confirmation_token, :confirmation_token, :confirmed_at,
